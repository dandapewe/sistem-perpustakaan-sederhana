...
class MockRepositoryBukuTest {
    ...
    void setup() {
        ...
        // Setup sample data
        bukul = new Buku("1234567890", "Pemrograman Java", "John Doe", 5, 150000.0);
    ...
    void testSimpanBukuBaru() {
        // Act
        boolean hasil = mockRepository.simpan(bukul);
        // Assert
        assertTrue(hasil, "Harus berhasil menyimpan buku baru");
        assertEquals(1, mockRepository.ukuran(), "Repository harus berisi 1 buku");
        assertTrue(mockRepository.mengandung("1234567890"), "Repository harus mengandung ISBN bukul");
    }
    ...
    void testCariByJudulCaseInsensitive() {
        // Arrange
        mockRepository.simpan(bukul); // "Pemrograman Java"
        mockRepository.simpan(buku2);
    ...
    void testCariByPengarang() {
        // Arrange
        mockRepository.simpan(bukul); // John Doe
    ...
    void testHapusBukuYangAda() {
        ...
        assertFalse(mockRepository.mengandung("1234567890"), "Bukul harus sudah dihapus");
    ...
    @Test
    @DisplayName("Hapus buku dengan ISBN null harus gagal")
    ...
    void testUpdateJumlahTersediaValid() {
        // Arrange
        mockRepository.simpan(bukul); // jumlahTotal 5, jumlahTersedia = 5
        // Act
    ...
    void testUpdateJumlahTersediaMelebihiTotal() {
        // Arrange
        mockRepository.simpan(bukul); // jumlahTotal 5
        ...
        assertFalse(hasil, "Harus gagal untuk jumlah melebihi total");
    }
    ...
    void testCariSemuaRepositoryBerisi() {
        ...
        assertTrue(hasil.contains(bukul));
