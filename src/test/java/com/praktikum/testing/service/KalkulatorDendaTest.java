...
public class KalkulatorDendaTest {
    ...
    void testTidakAdaDendaUntukPeminjamanTidakTerlambat() {
        LocalDate tanggalPinjam = LocalDate.now().minusDays(2);
    ...
    void testAdaDenda() {
        ...
        Peminjaman peminjamanTerlambat = new Peminjaman("P001", "M001", "1234567890", LocalDate.now(), tanggalJatuhTempo);
        assertTrue(kalkulatorDenda.adaDenda(peminjamanTerlambat));

        // Peminjaman tidak terlambat
        Peminjaman peminjamanTidakTerlambat = new Peminjaman("P002", "M001", "1234567890", LocalDate.now().minusDays(2), LocalDate.now().plusDays(1));
